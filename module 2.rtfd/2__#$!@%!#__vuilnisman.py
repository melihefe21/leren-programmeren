naam = str(input('hoe heet u?'))
gender = input ('ben je een man of een vrouw?')
if gender == 'milf':
    print('u mag gelijk verder!!!')
if gender == 'vrouw':
    kleur = input('heeft u rood haar?')
    haren = int(input('hoelang zijn uw krullen?'))
elif gender == 'man':
    knor = input('heeft u een snor?')
    if knor == 'ja':
...
if leeftijd <= '17':
    print('wegwezen van hier je bent te jong dus kom niet hier')
hoelang = int(input('hoelang heeft u op school gezeten?'))
wat = input('wat bent u (mens, dier, alien, krypton, iets...?')
if wat == 'dier':
    print('weg wezen van hier jij vieze dier')





if dieren >= 4 or jongleren >= 5 or acrobatiek >= 4 and rijbewijs == 'ja' and hoed == 'ja' and diploma >= 4 and (gender == 'man' and snor == 'ja') or (gender == 'vrouw' and kleur == 'ja' and haren >= 20) and lengte >=150 and lengte <= 220 and zwaar >= 90 and zwaar <= 120 and certificaat == 'ja' and leeftijd >= 18 and hoelang >= 12 and wat == 'mens':
